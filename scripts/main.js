...
function enterKey(e) {
    ...
    if (e.keyCode == 13) {
        ...
        git = commands.length;
        addLine("Vatsa's Portfolio:~$ " + command.innerHTML, "no-animation", 0);
...
function router(cmd){
    switch (cmd.toLowerCase()) {
        ...
        case "email":
            addLine('Opening mailto:<a href="mailto:vatsajoshi2@gmail.com"vatsajoshi2@gmail.com</a>...', "color2", 80);
            openNewTab(email);
            break;
